<?php
/**
 * Template for displaying the glove parent archive.
 *
...
<div class="archive parent <?php echo GLOVE_POST_TYPE; ?>">
			...
			<?php foreach( $parent_terms as $parent_term ) { ?>
				...
				<?php if ( $image_source ) { ?>
					<div class="content-item col-xs-12 col-sm-4">
						<a href="<?php echo home_url( '/gloves/' . esc_attr( $parent_term->slug ) ); ?>">
							<figure class="image">
