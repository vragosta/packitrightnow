<?php
/**
 * Template for displaying the package child archive.
 *
...
$package_slug = get_query_var( 'package' );
$parent_term = get_term_by( 'slug', $package_slug, PACKAGE_TYPE_TAXONOMY );
$child_terms = get_child_terms( PACKAGE_TYPE_TAXONOMY, $parent_term->term_id );

get_header(); ?>

<div class="archive child <?php echo PACKAGE_POST_TYPE; ?>">
