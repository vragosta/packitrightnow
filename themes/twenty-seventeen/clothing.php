<?php
/**
 * Template for displaying the clothing child archive.
 *
...
$clothing_slug = get_query_var( 'clothing' );
$parent_term = get_term_by( 'slug', $clothing_slug, CLOTHING_TYPE_TAXONOMY );
$child_terms = get_child_terms( CLOTHING_TYPE_TAXONOMY, $parent_term->term_id );

get_header(); ?>

<div class="archive child <?php echo CLOTHING_POST_TYPE; ?>">
